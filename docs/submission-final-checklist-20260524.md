...
- 작성일은 실제 제출일 기준으로 맞춥니다. 2026-05-25 제출이면 `2026년 05월 25일`입니다. `/capture` 증빙 화면은 기본값 `2026-05-25`를 사용합니다.
...
- 유사 서비스 대비 차별성은 `국내 통합돌봄 담당자용 72시간 사례 검토·문서화 업무 보조 서비스`로 쓰고, 근거는 `docs/market-landscape-20260525.md`를 기준으로 맞춥니다.

## 2. 첨부5 캡처 순서와 캡션

| 순서 | 파일 | 캡션 |
| --- | --- | --- |
| 1 | `captures/01-input.png` | 시연용 사례와 생활환경 입력 화면 |
...
| 8 | `captures/08-mobile.png` | 모바일 화면에서도 확인 가능한 담당자 업무 화면 |
| 9 | `captures/09-status.png` | 운영 상태와 필수 연동 준비 확인 화면 |

최종 캡처 용도와 첨부 우선순위는 `docs/submission-capture-manifest-20260525.md`를 기준으로 확인합니다.
