...
const pilotSteps = [
  ...
  ["2", "데이터 연결", "시연용 사례와 공공데이터를 먼저 연결하고, HIRA 맞춤형 데이터는 별도 절차로 반영합니다."],
...
const readinessItems = [
  ...
  "국민건강보험공단 장기요양기관 검색 서비스와 HIRA 병원정보서비스 연동 준비",
  "시연용 사례 기반 검증, 민감정보 입력 차단, 운영 원칙 검사",
...
const adoptionPackages = [
  {
    ...
    scope: "시연용 사례 기반 업무 흐름 검증, 담당자 피드백 반영, 공공데이터 연결 확인",
